...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Experience}
            \cvevent{Computer scientist: Workflow for deep learning pipeline }{| Contractor, Battelle Memorial Institute (Checks and Balances, Inc.) }{September 2021 -- Present}{Boulder, Colorado, USA}
            \begin{itemize}
                \item Developing \highlight{workflows} that connect multiple \highlight{deep learning algorithms} and image processing tools into analytical pipelines to extract morphological traits in fish.
