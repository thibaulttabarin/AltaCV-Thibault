...
\begin{document}
    ...
    \tagline{Image analyst and data scientist}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Experience}
            ...
            \begin{itemize}
                ...
                \item Worked with \highlight{large dataset} of brain images. Developed code to handle large sized image analysis (more than 10GB per image)
            ...
            \begin{itemize}
            	   	...
            	   	\item Used machine learning algorithms to \highlight{detect} and \highlight{quantify protein clusters} in the membrane of immune cells (T lymphocytes) using image-based and point pattern analysis for large-sized images (several GB per image).
	   		        \item Implemented  \highlight{clustering}, \highlight{classification} and \highlight{morphology characterization} software.
	   		        \item Integrated the different parts of the analysis in a graphical interface and provided biologist collaborators with a \highlight{end product for large data analysis}.
